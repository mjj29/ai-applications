...
const SUBTABS = ['subtab-edit', 'subtab-position', 'subtab-lookup', 'subtab-print', 'subtab-chat', 'subtab-auction', 'subtab-help'];
...
function renderSubtab(id) {
  ...
  if (id === 'subtab-help')     renderHelp(document.getElementById('subtab-help'));
}
